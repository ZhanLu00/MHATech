...
class WelcomeUserBot(ActivityHandler):
    def __init__(self, user_state: UserState):
        ...
        self.WELCOME_MESSAGE = """Thank you for signing up to try our texting program. 
                        This is an early version of a texting program being developed by Mental 
                        Health America, Northwestern University, and University of Toronto. We 
                        will be texting you from this number over the next 2 weeks. """
        ...
        self.INFO_MESSAGE = """Today or tomorrow, can you please follow this link to answer a brief 
                        (< 5 min) survey about your mental health symptoms: 
                        https://northwestern.az1.qualtrics.com/jfe/form/SV_bOTaT86x05gcfWJ
                        \nAt the end of the two weeks, we will ask you to complete the same survey again,
                         and we will get in touch to schedule an interview."""

        self.INFO_MESSAGE2 = """This early version of the texting program includes several different 
                        types of content aimed at managing mood and mental health. Some messages will 
                        ask you to text back with your preferences, thoughts, and ratings. We'll use 
                        this symbol ✍ whenever we're asking you to respond. You can text back other 
                        times as well, but keep in mind that the program isn't set up to understand or 
                        respond to what you write."""
        
        self.INFO_MESSAGE3 = """If at any point you have questions about the texting program, need help, 
                        or you want to stop receiving messages, please email Rachel Kornfield at 
                        rachel.kornfield@northwestern.edu or Bei Pang (Research Assistant) at 
                        pangbei511@gmail.com."""
    ...
    async def on_members_added_activity(
        ...
        for member in members_added:
            if member.id != turn_context.activity.recipient.id:
                ...
                await turn_context.send_activity(self.INFO_MESSAGE2)

                await turn_context.send_activity(
                    f"We will try to message you between [min time] and [max time]. " + self.INFO_MESSAGE3
                )
